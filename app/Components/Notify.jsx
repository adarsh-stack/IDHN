...
//   // Simulate picking up notifications from the local backend architecture
//   useEffect(() => {
//     // In your full app, replace this mock data with an API call to your local database/FastAPI sidecar
...
// // Clean UI styles matching your dark theme header
// const styles = {
//   container: {
//     position: 'relative',
