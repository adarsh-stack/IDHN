...
export async function handleRegister(
  ...
  if (!name || !email || !password) {
    return {
      success: false,
      message: "Please provide full registration details.",
    };
  }
  ...
  try {
    ...
    if (existingUser) {
      return {
        success: false,
        message: "This email is already registered in the IDHN network.",
      };
    }
    ...
    return {
      success: false,
      message: "Cluster database registration write failed.",
    };
  }
}
